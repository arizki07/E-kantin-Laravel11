...
@section('content')
                        ...
                        <div class="card card-xl shadow rounded border border-blue">
                            <div class="table-responsive">
                                <table style="width:100%; height: 100%;font-size:13px;"
                                    class="table table-bordered table-vcenter card-table table-hover text-nowrap datatable datatable-cetak">
                                </table>
                            </div>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            var tableCetak = $('.datatable-cetak').DataTable({
                "processing": true,
                "serverSide": false,
                "scrollX": false,
                ...
                "language": {
                    ...
                    "select": {
                        rows: {
                            _: "%d item dipilih ",
                            0: "Pilih item dan tekan tombol Proses data untuk cetak QR ",
                        }
                    },
                },
                "ajax": {
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return data ?
                                '<span class="status-dot status-dot-animated status-blue" style="font-size:11px"></span> <b class="text-blue">Aktif</b>' :
                                '<span class="status-dot status-dot-animated status-red" style="font-size:11px"></span> <b class="text-red">Diberhentikan</b>';
                        }
                    },
                ],
